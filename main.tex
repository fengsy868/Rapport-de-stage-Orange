...
{\supname} \\% Supervisor name - remove the \href bracket to remove the link
Ingénieur Chercheur, \ \ EDF R\&D/SINETICS/I23\\
Tel : 01.47.65.36.77\qquad E-mail : \href{mailto:pierre.guerin@edf.fr}{pierre.guerin@edf.fr}\\[0.3cm]
{\supnamex} \\% Supervisor name - remove the \href bracket to remove the link
Chef de Projet,\qquad\quad \ EDF R\&D/SINETICS/I28\\
Tel : 01.47.65.49.44\qquad E-mail : \href{mailto:andreas.schumm@edf.fr}{andreas.schumm@edf.fr}\\[0.3cm]
{\supnamexx} \\% Supervisor name - remove the \href bracket to remove the link  
Ingénieur Chercheur, \ \ EDF R\&D/SINETICS/I23\\
Tel : 01.47.65.33.47\qquad E-mail : \href{mailto:francois.fevotte@edf.fr}{francois.fevotte@edf.fr}\\[0.8cm]

\emph{\Large Academic Supervisor:}\\[0.5cm]
{\examname} \\
Maître de Conférences\\
Université Pierre et Marie Curie - LIP6\\
Tel : 01.44.27.87.73\qquad E-mail : \href{mailto:pierre.fortin@lip6.fr}{pierre.fortin@lip6.fr}
}
...
The internship opportunity I had with I23 group was a great chance for learning and professional development. It's here at EDF R\&D that I strengthened my willing to future research careers. Therefore, I consider myself as a very lucky individual as I was provided with an opportunity to be a part of it. I am sincerely grateful for having a chance to meet so many wonderful people and professionals who led me through this six-month internship.

First and foremost I would like to express my deepest gratitude to Pierre Guérin, my major supervisor at EDF, for his patient guidance, enthusiastic encouragement and useful proposals for my work.

I would also like to offer my special thanks to Andreas Schumm who took time out to hear and guide me to get a better understanding on MODERATO.

Also many thanks to François Févotte, Bruno Lathuilière and my academic supervisor Pierre Fortin who offer valuable advices.

Last, but not least, I would like to express my thanks to all I23 members. Thank you all for the fabulous coffee time we had together!
}
